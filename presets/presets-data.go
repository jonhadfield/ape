...
func presetsFilesAwsPlaybookYml() (*asset, error) {
	...
	info := bindataFileInfo{name: "presets-files/aws/playbook.yml", size: 1391, mode: os.FileMode(420), modTime: time.Unix(1674419329, 0)}
...
func presetsFilesAwsPoliciesYml() (*asset, error) {
	...
	info := bindataFileInfo{name: "presets-files/aws/policies.yml", size: 0, mode: os.FileMode(420), modTime: time.Unix(1674419329, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func presetsFilesCisFoundationsPoliciesYml() (*asset, error) {
	...
	info := bindataFileInfo{name: "presets-files/cis-foundations/policies.yml", size: 12925, mode: os.FileMode(420), modTime: time.Unix(1674419329, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
